...
# Build Environment
export ARCH=arm
export CROSS_COMPILE=/home/erik/android/kernel/toolchains/arm-cortex_a8-linux-gnueabi-linaro_4.6.4-2013.05/bin/arm-cortex_a8-linux-gnueabi-
...
IMAGE_DIR=../output/cm10/zImage
MODULE_DIR=../output/cm10/ramdisk/lib/modules/
RAMDISK_DIR=../output/cm10/ramdisk/
KERNEL_DIR=out
