...
BASE_PHENOM_VER="PhenomKernel_v3.9.4_362MB_exUV_CM10"

# Build Environment
export ARCH=arm
export CROSS_COMPILE=/home/erik/android/kernel/toolchains/arm-cortex_a8-linux-gnueabi-linaro_4.7.4-2013.05/bin/arm-cortex_a8-linux-gnueabi-
...
MODULE_DIR=../output/cm10.1/ramdisk/lib/modules/
