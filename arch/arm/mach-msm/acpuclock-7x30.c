...
/*  {A,0,1,0}, / X Mhz / -> A+1 = X+19,2 Mhz */

	{  42, 0, 1, 0 }, /*  806,4 MHz */
	{  47, 1, 3, 0 }, /*  902,4 MHz NEW*/

	{  53, 1, 3, 0 }, /* 1017,6 MHz NEW*/
	{  58, 1, 3, 0 }, /* 1113,6 MHz NEW*/
	{  63, 1, 3, 0 }, /* 1209,6 MHz NEW*/
	{  68, 1, 3, 0 }, /* 1305,6 MHz NEW*/
	{  73, 0, 1, 0 }, /* 1401,6 MHz */

#ifdef CONFIG_ARIESVE_OVERCLOCKING
 	{  79, 1, 3, 0 }, /* 1516,8 MHz NEW*/
 	{  81, 1, 3, 0 }, /* 1555,2 MHz NEW*/
	{  84, 1, 3, 0 }, /* 1612,8 MHz NEW*/
	{  86, 1, 3, 0 }, /* 1651,2 MHz NEW*/
	{  89, 1, 3, 0 }, /* 1708,8 MHz NEW*/
	{  92, 1, 3, 0 }, /* 1766,4 MHz NEW*/
	{  94, 1, 3, 0 }, /* 1804,8 MHz NEW*/
	{  95, 1, 3, 0 }, /* 1824,0 MHz NEW*/
#endif
};
...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	{ 0, 24576,  SRC_LPXO, 0, 0,  30720000,  825, VDD_RAW(825) },
	{ 0, 61440,  PLL_3,    5, 11, 61440000,  825, VDD_RAW(825) },
	...
	{ 1, 902400,  PLL_2, 3, 0, UINT_MAX, 1025, VDD_RAW(1025), &pll2_tbl[1]},

	{ 1, 1017600, PLL_2, 3, 0, UINT_MAX, 1050, VDD_RAW(1050), &pll2_tbl[2]},
...
#ifdef CONFIG_ARIESVE_OVERCLOCKING
/* Commenting this to get access to OC-Feature 
